...
Download the zip file from the WordPress Plugin directory and upload it in your plugin dashboard or direclty install it from your dashboard by going to the "Plugins > Add" menu. Look for "Rewrite Email Address" in the search input, install and activate it.
